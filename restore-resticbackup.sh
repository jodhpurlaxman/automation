...
read username
AWS_ACCESS_KEY_ID=$(ls /home/cyberpanel/aws/); AWS_SECRET_ACCESS_KEY=$(cat /home/cyberpanel/aws/$AWS_ACCESS_KEY_ID); restic -r s3:usc1.contabostorage.com/$username snapshot
